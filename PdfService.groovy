...
class PdfService {
    ...
    def logoDir = org.codehaus.groovy.grails.web.context.ServletContextHolder.getServletContext().getRealPath("/images/logos/xxxxx.png")
    ...
    def createIndicationDoc(submissionMap, productDetailArray){
        ...
        productDetailArray.quoteID.each {
            ...
            //CREATE INDICIATION
            byte[] newIndicationByteArray= createIndicationPage(submissionMap, productDetailArray);
    ...
    def createIndicationPage(submissionMap, productDetailArray){
...
//            insertLimitDeductibleSection()
    ...
    def insertCoverHeader(){
        ...
        contents.showText("THE COMPANY - Personal Lines");
        ...
        contents.setFont(cursorFont, cursorFontSize)
        contents.newLineAtOffset(coverHeaderLeftX, headerLeftY);
        contents.showText("1234 STREET ADDRESS");
        contents.newLineAtOffset(coverHeaderRightX, 0)
        ...
        contents.setFont(cursorFont, cursorFontSize)
        contents.newLineAtOffset(coverHeaderLeftX, headerLeftY);
        contents.showText("LOS ANGELES, CA 90277");
        contents.endText();
        ...
        contents.setFont(cursorFont, cursorFontSize)
        contents.newLineAtOffset(coverHeaderLeftX, headerLeftY);
        contents.showText("(XXX) XXX-XXXX");
        contents.endText();
        ...
        contents.setFont(cursorFont, cursorFontSize)
        contents.newLineAtOffset(coverHeaderLeftX, headerLeftY);
        contents.showText("Agent: XXXXX XXXX");
        contents.endText();
        ...
        contents.setFont(cursorFont, cursorFontSize)
        contents.newLineAtOffset(coverHeaderLeftX, headerLeftY);
        contents.showText("Email: XXXX@company.com");
        contents.endText();
    ...
    def insertHeader(){
        ...
        contents.showText("Los Angeles ,CA 90277");
        contents.newLineAtOffset(headerRightX, 0)
        contents.showText("Email: XXXXX@company.com");
        contents.endText();
